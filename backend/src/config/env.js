...
export const env = {
  ...
  leagueContextUpcomingCacheTtlSeconds: readNumber("LEAGUE_CONTEXT_UPCOMING_CACHE_TTL_SECONDS", 3600),
  ...
  betaModeEnabled: readBoolean("BETA_MODE_ENABLED", true),
  billingCurrency: process.env.BILLING_CURRENCY ?? "USD",
  proMonthlyPriceUsd: readNumber("PRO_MONTHLY_PRICE_USD", 5.99),
