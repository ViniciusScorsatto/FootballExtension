(function initLiveMatchImpactI18n(globalScope) {
  const dictionaries = {
    en: {
      ...
      impact: {
        ...
        oneGoalFromPenalties: "{team} is one goal from taking the tie to penalties",
        needsMoreGoalsPenalties: "{team} still needs {count} more goals to take the tie to penalties",
        ...
        tieToExtraTime: "Level score would send this tie to extra time.",
        headingExtraTime: "This tie is currently heading to extra time",
      ...
      prematch: {
        ...
        lineupPitchAria: "Formation layout {value}",
    ...
    "pt-BR": {
      ...
      impact: {
        ...
        oneGoalFromPenalties: "{team} está a um gol de levar o confronto para os pênaltis",
        needsMoreGoalsPenalties:
          "{team} ainda precisa de mais {count} gols para levar o confronto para os pênaltis",
        ...
        tieToExtraTime: "Empate leva a decisão para a prorrogação.",
        headingExtraTime: "No momento, este confronto vai para a prorrogação",
      ...
      prematch: {
        ...
        lineupPitchAria: "Esquema da formação {value}",
        formationTbc: "Formação a confirmar",
        coachLabel: "Técnico {name}",
  ...
  function translateCompetitionMessage(language, message) {
    const patterns = [
      ...
      [/^(.+) is one goal from taking the tie to penalties$/, "impact.oneGoalFromPenalties", ["team"]],
      [/^(.+) still needs (\d+) more goals to take the tie to penalties$/, "impact.needsMoreGoalsPenalties", ["team", "count"]],
      ...
      [/^Level score would send this tie to extra time\.$/, "impact.tieToExtraTime", []],
      [/^This tie is currently heading to extra time$/, "impact.headingExtraTime", []],
